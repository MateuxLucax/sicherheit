...
<?php
	...
	$tipoPesquisa = isset($_POST['tipoPesquisa']) ? $_POST['tipoPesquisa'] : 'simples';
            ...
            <div class="card-panel">
                ...
                <form action="" method="POST">
                    ...
                    <div class="row" id="pesquisaAvancada">
                        <div class="col s12 m8 offset-m2">
                            <div class="input-field">
                                <select name="filtro" id="selectFiltro" onchange="periodo()">
                                    <option value="0" disabled selected>Escolha uma opção</option>
                                    <option value="Placa">Placa</option>
                                    <option value="Fabricante">Fabricante</option>
                                    <option value="Modelo">Modelo</option>
                                    <option value="Periodo">Ano dos carros</option>
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="divOptionPeriodo">
                                <div class="row">
                                    <div class="col s12 center"><h6 class="title" style="margin-top: 2rem;">Escolha um intervalo para o ano dos carros</h6></div>
                                </div>
                                <div class="row">
                                    <div class="col s5 m3 offset-m2">
                                        <div class="input-field">
                                            <input id="periodoAnoInicial" type="number" name="anoInicial" data-mask="0000" class="validate">
                                            <label for="periodoAnoInicial">Ano inicial</label>
                                        </div>
                                    </div>
                                    <div class="col s2 m2 center"><p style="margin-top: 2rem;">E</p></div>
                                    <div class="col s5 m3">
                                        <div class="input-field">
                                            <input id="periodoAnoFinal" type="number" name="anoFinal" data-mask="0000" class="validate">
                                            <label for="periodoAnoFinal">Ano final</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <input type="hidden" name="tipoPesquisa" id="tipoPesquisa">
                </form>
            </div>
        </div>
    </div>
          ...
          if ($pesquisa == '') {
            ...
            if ($pesquisa == '') {
              $sql = "SELECT * FROM ". $nomeTabela;
                ...
                $anoInical = isset($_POST['anoInicial']) ? $_POST['anoInicial'] : '';
                $anoFinal = isset($_POST['anoFinal']) ? $_POST['anoFinal'] : '';
                $sql = betweenSQLSimples($nomeTabela, 'Ano', $anoInical, $anoFinal);
            }
        } else {
            $sql = "SELECT * FROM ". $nomeTabela;
        }
                ...
                <div class="col s12">
                    ...
                    <table class="highlight centered responsive-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <span class="title left-align">Média de ano de todos os carros</span>
                                </td>
                                <td></td><td></td><td></td><td></td><td></td>
                                <td>
                                    <?php echo number_format(avgSQL($tabelaCarro, 'Ano'), 0, '', ''); ?>
                                </td>
                            </tr>
                            <!-- Adicionar -->
                            <tr>
...
<footer class="page-footer">
  ...
  <script src="assets/js/initCarros.js"></script>
